...
author:
- Carsten Wulff, 2023-10-26, v0.1.1
title: Diodes
...
![Intrinsic carrier concentration versus temperature\label{fig:ni}](../media/ni.pdf)
<!--pan_doc:
...
![Diode forward voltage as a function of temperature \label{fig:vd}](../media/vd.pdf)
...
![Circuit to generate a current proportional to kT\label{fig:ptat}](../media/l3_ptat.pdf)
